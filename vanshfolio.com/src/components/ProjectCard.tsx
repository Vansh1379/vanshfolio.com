...
const ProjectCard = ({
    ...
    return (
        <div className="bg-white rounded-2xl flex mt-7 " >
            <div className="hover:bg-gray-50 flex cursor-pointer" onClick={HandleRouting}>
                <div className="mt-4  rounded-2xl">
                    <img src={url} alt="" className=" h-36 object-fit rounded-xl" />
                </div>
                <div className="mt-4  pl-4 mr-4 mb-1">
                    <div className="">
