...
import balance from "../assets/images/Vpaybalance.png"
    ...
    <div className="container mx-auto max-w-4xl px-4 sm:px-6 py-16">
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-2 mt-8">
          ...
          <div className="bg-gray-100 rounded-lg">
            <div className="cursor-pointer">
              <img
                src="https://imgs.search.brave.com/QPOQP86GEHuYa9An9K7pqf3Ts-pOKkJMKxcaFJBeEa4/rs:fit:500:0:0:0/g:ce/aHR0cHM6Ly9wd2Vi/YXNzZXRzLnBheXRt/LmNvbS9jb21tb253/ZWJhc3NldHMvaXIv/aW1hZ2VzL3ByZXNz/LWtpdC9icmFuZC5w/bmc"
                alt="Cart image"
                className="w-full h-full object-cover p-2"
              />
            </div>
      ...
      <div className="mt-10 mb-20">
        <button type="button" className="bg-customBlue px-3 py-2.5 rounded-3xl flex items-center justify-center hover:shadow-2xl"
          onClick={() => { window.location.href = "https://v-pay-liard.vercel.app/" }}>
