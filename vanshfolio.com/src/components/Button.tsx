...
const Button = () => {
    ...
    const [items] = useState([
        ...
        {
            id: 2, title: "About", icon: (<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-4 hover:text-blue-500">
        ...
        {
            id: 3, title: "Projects", icon: (<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-4 hover:text-blue-500">
        ...
        {
            id: 4, title: "Techstack", icon: (<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-4 hover:text-blue-500">
        ...
        {
            id: 5, title: "Contact", icon: (<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-4 hover:text-blue-500">
        ...
        <div className="w-40 rounded-lg pt-8">
            ...
            <div className="pt-10 pl-5 flex items-center pb-7">
                <button type="button" className="bg-customBlue px-3 py-2.5 rounded-3xl flex items-center justify-center hover:shadow-2xl">
                    ...
                    <span className="pl-1"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-4 text-white flex items-center justify-center">
