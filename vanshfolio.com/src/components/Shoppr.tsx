...
import ProductLanding from "../assets/images/ProductLanding.png"
import SpecificProduct from "../assets/images/SpecificProduct.png"
    ...
    <div className="container mx-auto max-w-4xl px-4 sm:px-6 py-16">
      ...
      <div className="mt-10 mb-20">
        <button type="button" className="bg-customBlue px-3 py-2.5 rounded-3xl flex items-center justify-center hover:shadow-2xl"
          onClick={() => { window.location.href = "https://shoppr-beta.vercel.app" }}>
